...
void AShooterCharacter::BeginPlay()
{
	...
	//interp locations structs for each loc in arrray
...
bool AShooterCharacter::GetBeamEndLocation(const FVector& MuzzleSocketLocation, FVector& OutBeamLocation)
{
	...
	//trace for gunbarrel
			//perform the second trace for gun barrel
...
void AShooterCharacter::CalculateCrosshairSpread(float DeltaTime)
{
	...
	//count crosshair velocity (run or stand)
	CrosshairVelocityFactor = FMath::GetMappedRangeValueClamped(WalkSpeedRange, VelocityMultiplierRange, Velocity.Size());

	//count crosshair in air, else on ground then shrink
...
bool AShooterCharacter::TraceUnderCrosshairs(FHitResult& OutHitResult, FVector& OutHitLocation)
{
	...
	if (bScreenToWorld)
	{
		//trace from crosshairs world location
	...
	if (bShouldTraceForItems)
	{
		...
		if (ItemTraceResult.bBlockingHit)
		{
			...
			if (TraceHitItemLastFrame)
			{
				...
				{
					//hitting a different item this frame from the last frame
					TraceHitItemLastFrame->GetPickupWidget()->SetVisibility(false);
				}
			}

			//store a ref to hit item for the next frame
...
{
	if (WeaponToEquip)
		//set area sphere to ignore collision channels
	{
...
void AShooterCharacter::InitializeAmmoMap()
{
	...
	AmmoMap.Add(EAmmoType::EAT_IG, StartingIGAmmo);
}
...
void AShooterCharacter::InterpCapsuleHalfHeight(float DeltaTime)
{
	...
	//minus if crouch, plus if stand = fix when mesh is lower than should be
...
void AShooterCharacter::Tick(float DeltaTime)
{
	...
	//handle inerpolation for zoom when aiming
	CameraInterpZoom(DeltaTime);

	//change look sensitivity while aiming
	SetLookRates();
...
void AShooterCharacter::FinishReloading()
{
	...
	if (AmmoMap.Contains(AmmoType))
	{
		...
		{
			//reload the magazine with all ammo
